...
recorrer_directorio("tomates-recortados-buenos", listdir("./tomates-recortados-buenos"), "1 0 0 0 0")
recorrer_directorio("tomates-recortados-malos",  listdir("./tomates-recortados-malos"), "0 1 0 0 0")
recorrer_directorio("tomates-recortados-verdes-buenos", listdir("./tomates-recortados-verdes-buenos"), "0 0 1 0 0")